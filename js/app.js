(function(window) {
   ...
   *   and passing two aditional arguments, event and 'light-green'
   */
  btn5.addEventListener('click', e => setMyLightClass.apply(btn5, [e, 'light-green']));
   ...
   * to set the context to the correct object
   */
  btn7.addEventListener('click', e => setMyLightGreen.call(e.target));
   ...
   *   and passing two aditional arguments, event and 'light-green'
   */
  btn9.addEventListener('click', e => setMyLightClass.call(e.target, e, 'light-green'));
